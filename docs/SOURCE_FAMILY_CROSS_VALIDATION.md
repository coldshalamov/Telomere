...
- Native public-preset clean win held-outs: `4`
...
- Conclusion: `source-family exact seed-span compression generalizes across held-out Rust files and now tests both leave-one-out and frozen all-heldouts-excluded source presets against paired vocabulary-shadow and random controls; the frozen source-family preset also survives as native `.tlmr` v2 public-preset files, but coverage remains preset dependent`
...
| core/src/result.rs | `frozen-all-heldouts-excluded` | `heldout-source` | `native-v2-public-preset` | -594 | -594 | 849 | 59 | 0 | -653 | `True` |
...
| core/src/result.rs | `frozen-all-heldouts-excluded` | `paired-shadow-source` | `native-v2-public-preset` | 59 | 59 | 0 | 59 | 0 | 0 | `False` |
...
| core/src/result.rs | `frozen-all-heldouts-excluded` | `same-size-random` | `native-v2-public-preset` | 59 | 59 | 0 | 59 | 0 | 0 | `False` |
...
| core/src/option.rs | `frozen-all-heldouts-excluded` | `heldout-source` | `native-v2-public-preset` | -735 | -735 | 1135 | 59 | 0 | -794 | `True` |
...
| core/src/option.rs | `frozen-all-heldouts-excluded` | `paired-shadow-source` | `native-v2-public-preset` | 59 | 59 | 0 | 59 | 0 | 0 | `False` |
...
| core/src/option.rs | `frozen-all-heldouts-excluded` | `same-size-random` | `native-v2-public-preset` | 59 | 59 | 0 | 59 | 0 | 0 | `False` |
...
| alloc/src/string.rs | `frozen-all-heldouts-excluded` | `heldout-source` | `native-v2-public-preset` | -1046 | -1046 | 1201 | 61 | 0 | -1107 | `True` |
...
| alloc/src/string.rs | `frozen-all-heldouts-excluded` | `paired-shadow-source` | `native-v2-public-preset` | 61 | 61 | 0 | 61 | 0 | 0 | `False` |
...
| alloc/src/string.rs | `frozen-all-heldouts-excluded` | `same-size-random` | `native-v2-public-preset` | 61 | 61 | 0 | 61 | 0 | 0 | `False` |
...
| std/src/path.rs | `frozen-all-heldouts-excluded` | `heldout-source` | `native-v2-public-preset` | -2200 | -2200 | 1412 | 70 | 0 | -2270 | `True` |
...
| std/src/path.rs | `frozen-all-heldouts-excluded` | `paired-shadow-source` | `native-v2-public-preset` | 70 | 70 | 0 | 70 | 0 | 0 | `False` |
...
| std/src/path.rs | `frozen-all-heldouts-excluded` | `same-size-random` | `native-v2-public-preset` | 70 | 70 | 0 | 70 | 0 | 0 | `False` |
